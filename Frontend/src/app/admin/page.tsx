  ...
  if (!currentUser || currentUser.role !== "officer") {
    return (
      <div className="max-w-xl mx-auto px-6 py-20 text-center">
        ...
        <button onClick={() => router.push("/login/organizer")} 
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 py-8 relative perspective">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-8 relative z-10">
        <div className="stat-card-3d border-l-[4px] border-l-accent">
        ...
        <div className="stat-card-3d border-l-[4px] border-l-success">
          <div className="flex items-center gap-2 text-caption text-muted-foreground font-semibold uppercase tracking-wider mb-2">
        ...
        <div className="stat-card-3d border-l-[4px] border-l-primary">
          <div className="flex items-center gap-2 text-caption text-muted-foreground font-semibold uppercase tracking-wider mb-2">
      ...
      <div className="mb-8 relative z-10">
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-body-sm font-semibold transition-all ${
            isKycApproved
              ? "gradient-accent text-accent-foreground shadow-soft-md hover:shadow-soft-lg hover:-translate-y-0.5"
        ...
        {!isKycApproved && (
          <p className="text-caption text-warning text-center mt-2">
            ...
            <button onClick={() => router.push("/admin/profile")} className="underline ml-1 hover:text-warning/80 font-semibold">
              Go to Profile
            </button>
          </p>
        )}
      ...
      {/* Tenders Table */}
      <div className="bg-card border border-border rounded-2xl overflow-hidden card-depth relative z-10">
            ...
            <tbody className="divide-y divide-border">
              {tenders.map((tender: any) => (
                <tr key={tender.id} className="hover:bg-surface-container-low transition-colors">
                  <td className="p-3.5 text-caption font-mono font-semibold text-accent">{tender.id}</td>
      ...
      {/* Quick Actions */}
      <div className="mt-8 bg-card border border-border rounded-2xl p-6 card-depth card-3d-tilt relative z-10">
